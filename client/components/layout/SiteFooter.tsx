      ...
      <div className="container py-12">
            ...
            <div className="grid gap-6 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-3 text-sm sm:text-base text-[#1f2d3a]/90">
                  Investors, researchers, media, builders — let’s talk. We’re
                  forming partnerships to bring Clarra to life. No question is
                  too small.
                </p>
                <p className="mt-3 text-sm sm:text-base text-[#1f2d3a]/90">
                  Email us at{" "}
              ...
              <div className="flex md:justify-end">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center rounded-full bg-[#1f2d3a] px-12 py-6 text-2xl font-semibold text-white shadow-sm transition hover:bg-[#1f2d3a]/90"
                >
                  Contact us
                </Link>
              </div>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-3">
              <img
                ...
                alt="Clarra"
                className="h-[4.375rem] w-auto bg-transparent"
              />
            </div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-primary/40 pt-6 md:flex-row md:items-center">
          <p className="text-sm text-primary-foreground/80">
            © {new Date().getFullYear()} Carra Health, Inc. All rights
            reserved.
          </p>
