...
export default function Index() {
  return (
    <>
      {/* Hero */}
      <section className="relative bg-gradient-to-b from-[#FAFDFD] to-[#F4FBF9] pt-[90px] pb-20 md:pt-[120px] md:pb-24 min-h-[620px] overflow-visible">
        {/* Background Image */}
        <div className="absolute inset-0 w-full h-full overflow-visible">
          <img
            ...
            className="w-full h-full object-cover brightness-[0.95] saturate-[1.12] contrast-[1.15] shadow-[0px_0px_40px_rgba(0,0,0,0.06)] mix-blend-multiply"
