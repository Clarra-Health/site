              ...
              <DialogTrigger asChild>
                <div className="group relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer flex flex-col h-[28.8rem]">
                  <div className="relative overflow-hidden flex-[2]">
                    ...
                    <div className="absolute top-6 left-6 z-10 flex items-center gap-3 bg-black/60 backdrop-blur rounded-xl px-5 py-3">
                      <svg className="w-7 h-7 text-white flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path d="M6 4h12v2H6V4zm-1 6h2v8H5v-8zm3-2h2v10H8V8zm3-1h2v11h-2V7zm3 1h2v10h-2V8zm3-2h2v8h-2v-8z" />
                      </svg>
                      <span className="text-white text-base font-semibold whitespace-nowrap">45 mins Today</span>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 bg-primary p-6">
                    ...
                    <p className="font-serif text-primary-foreground text-lg italic font-light leading-tight">Stay active and energized</p>
                  </div>
                </div>
              </DialogTrigger>
              <DialogContent className="max-w-5xl p-0 overflow-hidden bg-transparent border-none shadow-none">
                <div className="relative w-full rounded-3xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 p-12 flex flex-col justify-between">
                    <div className="flex justify-between items-start">
                      <div>
                        <h2 className="text-5xl font-bold text-primary-foreground mb-3">Exercise & Movement</h2>
                        <p className="text-lg text-primary-foreground/90">Track activity and build sustainable fitness habits</p>
                      </div>
                      <DialogClose className="text-primary-foreground hover:opacity-80 flex-shrink-0">
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" /></svg>
                      </DialogClose>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-6">
                        <div className="bg-white/10 backdrop-blur rounded-xl p-6">
                          <p className="text-primary-foreground/75 text-base mb-2">Today's Activity</p>
                          <p className="text-4xl font-bold text-primary-foreground">45 mins</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur rounded-xl p-6">
                          <p className="text-primary-foreground/75 text-base mb-2">Weekly Goal</p>
                          <p className="text-4xl font-bold text-primary-foreground">150 mins</p>
                        </div>
                      </div>
                      <p className="text-primary-foreground/90 text-base leading-relaxed">Track your workouts, monitor intensity, and build sustainable fitness habits that energize your body and mind during midlife transitions.</p>
                    </div>
                  </div>
                </div>
              </DialogContent>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-20">
            ...
            <h2 className="font-display text-5xl sm:text-6xl font-bold text-[#1f2d3a] mb-6 leading-tight">
              ...
              <span className="block text-primary mt-2">intelligent systems</span>
            </h2>
            <p className="text-xl text-foreground/70">
              Advanced technology that turns data into actionable clarity.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Conversational Symptom Capture */}
            <div className="group relative rounded-2xl overflow-hidden backdrop-blur-lg bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-xl hover:bg-white/15 p-8 flex flex-col min-h-[420px]">
              <div className="flex-shrink-0 mb-6">
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center border border-primary/20 group-hover:border-primary/40 group-hover:from-primary/30 transition-all">
                  <svg className="h-7 w-7 text-primary" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-1.804 9-4.025s-4.03-4.025-9-4.025-9 1.804-9 4.025 4.03 4.025 9 4.025zm0 0c-4.97 0-9-1.804-9-4.025m0-12.495c0 2.221 4.03 4.025 9 4.025s9-1.804 9-4.025m0 12.495c0 2.221-4.03 4.025-9 4.025s-9-1.804-9-4.025" />
                  </svg>
                </div>
              </div>
              <h3 className="font-display text-2xl font-bold text-[#1f2d3a] mb-3 leading-tight group-hover:text-primary transition-colors">
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-xs font-semibold text-primary uppercase tracking-widest">Conversational Symptom Capture</p>
              </div>
            </div>

            {/* Pattern Recognition Across Midlife Systems */}
            <div className="group relative rounded-2xl overflow-hidden backdrop-blur-lg bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-xl hover:bg-white/15 p-8 flex flex-col min-h-[420px]">
              <div className="flex-shrink-0 mb-6">
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-secondary/20 to-secondary/10 flex items-center justify-center border border-secondary/20 group-hover:border-secondary/40 transition-all">
                  <svg className="h-7 w-7 text-secondary" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 12.75h.008v.008H9.75V12.75zm0 2.25h.008v.008H9.75v-2.25zm0 2.25h.008v.008H9.75v-2.25zm0 2.25h.008v.008H9.75v-2.25zM12 12.75h.008v.008H12V12.75zm0 2.25h.008v.008H12v-2.25zm0 2.25h.008v.008H12v-2.25zm0 2.25h.008v.008H12v-2.25zm3.75-9c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125H15m0-7.5h.008v.008H15v-2.25zm0 2.25h.008v.008H15v-2.25zm0 2.25h.008v.008H15v-2.25z" />
                  </svg>
                </div>
              </div>
              <h3 className="font-display text-2xl font-bold text-[#1f2d3a] mb-3 leading-tight group-hover:text-secondary transition-colors">
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-xs font-semibold text-secondary uppercase tracking-widest">Pattern Recognition</p>
              </div>
            </div>
            ...
            <div className="group relative rounded-2xl overflow-hidden backdrop-blur-lg bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-xl hover:bg-white/15 p-8 flex flex-col min-h-[420px]">
              <div className="flex-shrink-0 mb-6">
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-accent/20 to-accent/10 flex items-center justify-center border border-accent/20 group-hover:border-accent/40 transition-all">
                  <svg className="h-7 w-7 text-accent" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.348 14.651a3.75 3.75 0 002.604 1.076h.001c1.440 0 2.817-.588 3.804-1.628m0 0a6 6 0 00-8.956-8.956m0 0a6 6 0 018.956 8.956m-9.75 11.25h.008v.008h-.008v-.008zm0-2.25h.008v.008h-.008v-.008zm0-2.25h.008v.008h-.008v-.008z" />
                  </svg>
                </div>
              </div>
              <h3 className="font-display text-2xl font-bold text-[#1f2d3a] mb-3 leading-tight group-hover:text-accent transition-colors">
                Insights that actually explain what's happening
              </h3>
              <p className="text-sm text-foreground/70 leading-relaxed flex-grow">
                Clear, clinically meaningful interpretation—no generic tips.
              </p>
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-xs font-semibold text-accent uppercase tracking-widest">Contextual Insights</p>
              </div>
            </div>

            {/* Daily Guidance & Next Steps */}
            <div className="group relative rounded-2xl overflow-hidden backdrop-blur-lg bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-xl hover:bg-white/15 p-8 flex flex-col min-h-[420px]">
              <div className="flex-shrink-0 mb-6">
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-destructive/20 to-destructive/10 flex items-center justify-center border border-destructive/20 group-hover:border-destructive/40 transition-all">
                  <svg className="h-7 w-7 text-destructive" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
              </div>
              <h3 className="font-display text-2xl font-bold text-[#1f2d3a] mb-3 leading-tight group-hover:text-destructive transition-colors">
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-xs font-semibold text-destructive uppercase tracking-widest">Daily Guidance</p>
              </div>
            </div>
          </div>
        </div>
