  ...
  return (
    <>
      ...
      <section className="py-8">
        <div className="container">
          <div className="mx-auto max-w-5xl text-center">
            <h2 className="font-display text-5xl sm:text-6xl font-extrabold tracking-tight text-[#1f2d3a]">
      ...
      <section className="py-12">
        <div className="container">
          <div className="grid items-center gap-8 sm:grid-cols-2">
            <div className="sm:order-1 transform sm:translate-x-[15%]">
            ...
            <div className="sm:order-2 flex justify-center sm:justify-end transform sm:-translate-x-[30%]">
              <img
                ...
                className="w-full max-w-xs sm:max-w-sm md:max-w-md h-auto drop-shadow-2xl transform scale-[1.5]"
                loading="lazy"
                decoding="async"
              />
            </div>
