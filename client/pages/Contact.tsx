      ...
      <section className="py-12">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-5xl sm:text-6xl font-extrabold uppercase tracking-tight text-[#1f2d3a]">Contact us.</h1>
          ...
          <div className="mx-auto mt-10 flex max-w-3xl items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex h-16 w-16 items-center justify-center rounded-xl bg-[radial-gradient(circle_at_30%_107%,#fdf497_0%,#fdf497_5%,#fd5949_45%,#d6249f_60%,#285AEB_90%)] text-white shadow-sm transition hover:brightness-110"
            >
