        ...
        <div className="container mb-4">
          <h2 className="font-display text-center leading-tight text-[#1f2d3a] text-3xl sm:text-5xl md:text-6xl font-extrabold">
            ...
            <span className="relative inline-block align-baseline ml-2">
              ...
              <span
                aria-hidden
                className="absolute left-0 right-0 -bottom-[0.05em] h-[0.06em] bg-[hsl(25_97%_66%)]"
              ></span>
            </span>
            ...
            <span className="relative inline-block px-1 align-baseline">
              <svg
                aria-hidden
                className="pointer-events-none absolute -inset-[0.15em] -z-10"
                viewBox="0 0 100 50"
          ...
          <p className="font-display mt-3 text-center leading-tight text-[#1f2d3a] text-2xl sm:text-3xl">
            ...
            <span className="relative inline-block align-baseline ml-2">
              ...
              <span
                aria-hidden
                className="absolute left-0 right-0 -bottom-[0.1em] h-[0.08em] bg-[#1f2d3a]"
              ></span>
            </span>
            — built around
            <span className="relative inline-block px-1 align-baseline">
            ...
            <p className="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1f2d3a]">
              ...
              <span className="relative inline-block align-baseline">
                <span className="relative z-10">
                  we believe AI can redefine what healthcare looks like for
                  women in midlife.
                </span>
                <span
                  aria-hidden
                  className="absolute left-0 right-0 -bottom-[0.08em] h-[0.08em] bg-[hsl(25_97%_66%)]"
                ></span>
              </span>{" "}
              Every year, 47 million women worldwide enter menopause without the
              solutions they deserve—and we’re here to change that.
            </p>
            <div className="mt-4 space-y-4 text-base sm:text-lg text-foreground/85">
              <p>
                By bringing together biomarkers, wearable data, and lived
                symptoms, Clarra creates a comprehensive view of health that
                makes care more proactive and precise. Our AI doesn’t just track
                symptoms—it translates data into clear insights, helping detect
                risks sooner, anticipate challenges, and support smarter
                decisions.
              </p>
              <p>
                Our vision is simple: a system that is accurate, accessible, and
                scalable, where technology works for women and providers alike.
                With Clarra, midlife health is no longer invisible—it is
                understood, supported, and elevated to the standard of care
                women deserve.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mt-2 text-base sm:text-lg text-muted-foreground">
              Bold principles that guide every product decision.
            </p>
          </div>
          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl bg-[#b9e3e2] p-6 text-white shadow-md ring-2 ring-white/30">
              ...
              <p className="mt-2 text-sm opacity-95">
                predictive, personalized, evidence‑based.
              </p>
            </div>
            <div className="rounded-3xl bg-gradient-to-br from-[hsl(25_97%_66%)] to-[#ffb07a] p-6 text-white shadow-md ring-2 ring-white/30">
              ...
              <p className="mt-2 text-sm opacity-95">
                designed for diverse experiences.
              </p>
            </div>
            <div className="rounded-3xl bg-gradient-to-br from-[#1f2d3a] to-[#2c3e50] p-6 text-white shadow-md ring-2 ring-white/30">
              ...
              <p className="mt-2 text-sm opacity-95">
                Guided by leading science and clinical expertise.
              </p>
            </div>
            <div className="rounded-3xl bg-[#b9e3e2] p-6 text-white shadow-md ring-2 ring-white/30">
              <h3 className="text-xl font-extrabold">Clarity &amp; Action</h3>
              <p className="mt-2 text-sm opacity-90">
                from tracking to clear next steps.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-[#ffb07a] to-[hsl(25_97%_66%)] p-6 text-white shadow-md ring-2 ring-white/30">
              ...
              <p className="mt-2 text-sm opacity-95">
                support that makes menopause visible.
              </p>
            </div>
          </div>
        </div>
